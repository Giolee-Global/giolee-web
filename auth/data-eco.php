...
require_once "./config/db.php";
    ...
    WHERE services.serviceID = '7' LIMIT 1";
    ...
    $media_query = "SELECT filePath FROM media WHERE serviceID = '7'";
    ...
    $media_two_query = "SELECT filePath FROM media_two WHERE serviceID = '7'";
    ...
    $media_three_query = "SELECT filePath FROM media_three WHERE serviceID = '7'";
    ...
    $media_four_query = "SELECT filePath FROM media_four WHERE serviceID = '7'";
    ...
    $media_five_query = "SELECT filePath FROM media_five WHERE serviceID = '7'";
    ...
    $media_six_query = "SELECT filePath FROM media_six WHERE serviceID = '7'";
