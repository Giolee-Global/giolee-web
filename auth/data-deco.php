...
require_once "./config/db.php";
    ...
    WHERE services.serviceID = '9' LIMIT 1";
    ...
    $media_query = "SELECT filePath FROM media WHERE serviceID = '9'";
    ...
    $media_two_query = "SELECT filePath FROM media_two WHERE serviceID = '9'";
    ...
    $media_three_query = "SELECT filePath FROM media_three WHERE serviceID = '9'";
    ...
    $media_four_query = "SELECT filePath FROM media_four WHERE serviceID = '9'";
    ...
    $media_five_query = "SELECT filePath FROM media_five WHERE serviceID = '9'";
    ...
    $media_six_query = "SELECT filePath FROM media_six WHERE serviceID = '9'";
