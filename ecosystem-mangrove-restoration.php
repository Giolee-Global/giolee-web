...
?>
    ...
    <div class="breadcrumb__area" style="background-image: url('assets/img/mangrove.jpg');">
		<div class="container">
			<div class="row">
				<div class="col-xl-12">
					<div class="breadcrumb__area-content">
						<h2>Ecosystem Mangrove Restoration</h2>
						<ul>
							...
							<li>Ecosystem Mangrove Restoration</li>
						</ul>
					</div>
				</div>
			</div>
                    ...
                    <div class="services__details-area">
                        ...
                        <p class="mb-20">
                            ...
                            <ol>
                                ...
                                <li>Type of substrate(soil type)</li>
                        ...
                        <div class="row mt-40 mb-40">
                            <div class="col-sm-6 sm-mb-25">
                                <img class="img_full" src="assets/img/service/mangrove1.jpg"alt="image">
                            </div>
                            <div class="col-sm-6">
                                <img class="img_full" src="assets/img/service/mangrove3.jpg" alt="image">
                            </div>
                        </div>
                        <h4 class="mb-20">Technical Approach/Methodology</h4>
                        <p class="mb-20">Giolee’s method of mangrove restoration will employ the following approach to successfully rehabilitate the depleted mangrove and these will include basically;
                            <ul>
                                <li>Understand normal hydrology of the area</li>
                                <li>Assess modifications to hydrology or added stress;</li>
                                <li>Restore or create normal hydrology.</li>
                                <li>Selection of healthy seedlings.</li>
                                <li>Plant young mangroves as needed</li>
                                <li>Site hydrology study</li>
                            </ul>
                            ...
                            <ul>
                                <li>Blocked tidal exchange that might prevent secondary succession from occurring</li>
                                <li>Lack of groundwater</li>
                                <li>Shoreline abrasion and lowered substrate level and lack of sediments</li>
                            </ul>
                        </p>
